        ...
        <div className="min-h-screen bg-[#0a0a0f] relative overflow-hidden font-body text-white flex flex-col">
            ...
            >
                <div className="flex items-center gap-6">
                    <h1 className="font-display text-3xl text-white uppercase tracking-tight transform -skew-x-6 drop-shadow-[0_0_10px_rgba(45,106,242,0.8)]">
                        <span className="text-white">NITRO</span>
                        <span className="text-[#2d6af2]">MONITOR</span>
                    </h1>
                    ...
                    <div className="hidden md:flex items-center gap-2 bg-[#2d6af2]/10 border border-[#2d6af2]/30 px-4 py-2 rounded-lg">
                        ...
                        <span className="font-display tracking-widest text-[#2d6af2]">{participants.length}</span>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-8">
                    ...
                    <div className="flex items-center gap-3 bg-red-500/10 border border-red-500/30 px-6 py-2 rounded-xl shadow-[0_0_15px_rgba(239,68,68,0.2)]">
                        <Clock size={20} className={timeLeft < 60 ? "text-red-500 animate-pulse" : "text-white"} />
                        <span className={`font-display text-2xl tracking-widest ${timeLeft < 60 ? "text-red-500" : "text-white"}`}>
                            {formatTime(timeLeft)}
                        </span>
                    </div>
            ...
            <motion.div
                ...
                transition={{ duration: 0.6, delay: 0.1, type: "spring", stiffness: 100, damping: 14 }}
                ...
                <div className="max-w-7xl mx-auto space-y-4">
                                ...
                                >
                                    ...
                                    <div className="w-12 flex-shrink-0 flex justify-center z-10">
                                        {index === 0 && participants.length > 1 && progress > 0 ? (
                                            <Trophy className="text-yellow-400 drop-shadow-[0_0_10px_rgba(250,204,21,0.8)]" size={28} />
                                        ) : (
                                            <span className="font-display text-2xl text-white/40 group-hover:text-white/80 transition-colors">#{index + 1}</span>
                                        )}
                                    </div>

                                    {/* Player Info */}
                                    <div className="w-40 flex-shrink-0 space-y-1 z-10 px-2 border-r border-white/10">
                                        <p className="font-display text-white text-base truncate uppercase tracking-wider block" title={player.nickname}>
                                            {player.nickname}
                                        </p>
                                    ...
                                    <div className="flex-1 relative h-[60px] mx-6 flex items-center z-10">
                                        ...
                                        <div className="absolute inset-x-0 h-4 bg-gray-900 rounded-full border border-gray-700 shadow-inner flex items-center overflow-hidden">
                                            ...
                                            <div className="w-full h-[2px] bg-auto" style={{ backgroundImage: "linear-gradient(to right, rgba(255,255,255,0.2) 50%, transparent 50%)", backgroundSize: "20px 100%" }}></div>
                                        </div>
                    ...
                    {participants.length === 0 && (
                        <div className="h-64 flex flex-col items-center justify-center text-gray-500 bg-black/40 rounded-3xl border border-white/5">
                            ...
                            <p className="font-display tracking-[0.2em] text-lg uppercase text-[#2d6af2]/70">Waiting for Grid Protocol...</p>
                        </div>
                    )}
                </div>
            </motion.div>
