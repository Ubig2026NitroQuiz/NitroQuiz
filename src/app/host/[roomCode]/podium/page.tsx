                    ...
                    <div className="relative flex items-end justify-center w-full h-[300px] sm:h-[340px] mt-4 mb-4 px-2">
                        ...
                        {secondPlace && (
                            <motion.div custom={2} variants={podiumVariants} initial="hidden" animate="visible" className="flex flex-col items-center relative z-10 mx-[-8px] sm:mx-1">
                                ...
                                <div className="drop-shadow-[0_0_15px_rgba(200,200,200,0.4)]">
                                    <p className="text-4xl sm:text-5xl">🥈</p>
                                </div>
                                <div className="w-[85px] sm:w-[120px] h-[140px] sm:h-[180px] bg-gradient-to-b from-[#1a2235] to-[#0a0f1a] border-t-4 border-l border-r border-[#64748b] rounded-t-xl flex items-end justify-center pb-4">
                        ...
                        {firstPlace && (
                            <motion.div custom={3} variants={podiumVariants} initial="hidden" animate="visible" className="flex flex-col items-center relative z-20 mx-0 sm:mx-2 -mb-2">
                                ...
                                <div className="drop-shadow-[0_0_25px_rgba(250,204,21,0.6)]">
                                    <p className="text-5xl sm:text-7xl">🚀</p>
                                </div>
                                <div className="w-[100px] sm:w-[140px] h-[200px] sm:h-[250px] bg-gradient-to-b from-[#2a1f0a] to-[#0a0f1a] border-t-8 border-l-2 border-r-2 border-[#eab308] rounded-t-xl relative overflow-hidden flex items-end justify-center pb-6">
                                    ...
                                    <span className="font-display text-6xl sm:text-8xl text-yellow-600/40 font-bold">1</span>
                                </div>
                            </motion.div>
                        )}
                        ...
                        {thirdPlace && (
                            <motion.div custom={1} variants={podiumVariants} initial="hidden" animate="visible" className="flex flex-col items-center relative z-10 mx-[-8px] sm:mx-1">
                                ...
                                <div className="drop-shadow-[0_0_15px_rgba(194,65,12,0.4)]">
                                    <p className="text-3xl sm:text-4xl">🥉</p>
                                </div>
                                <div className="w-[75px] sm:w-[110px] h-[110px] sm:h-[150px] bg-gradient-to-b from-[#25140b] to-[#0a0f1a] border-t-4 border-l border-r border-[#c2410c] rounded-t-xl flex items-end justify-center pb-3">
