 ...
 * ─────────────────────
 * Efek visual latar belakang halaman pengaturan.
 * Menggunakan pola yang sama dengan halaman select-quiz:
 * grid hijau, grid perspektif, gradien radial, overlay, dan scanlines.
 */
